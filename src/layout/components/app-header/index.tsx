...
export function AppHeader() {
  ...
  return (
    <header className='flex w-full flex-col overflow-hidden relative select-none z-40'>
      <div
        className={clsx(
          'w-full h-10 flex items-center justify-between px-5 mt-6 pb-1 min-lg:mt-5 z-1 overflow-hidden',
          {
      ...
      <img
        ...
        className='fixed top-0 -left-4 right-0 w-full min-w-[110%] min-md:hidden duration-500'
      />
